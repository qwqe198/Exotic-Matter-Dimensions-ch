"use strict";
/*
normal-type research is refunded on Research respec		// 常规类型的研究在重置研究时会返还
permanent-type research is not refunded on Research respec		// 永久类型的研究在重置研究时不会返还
study-type research allows the player to enter a study and is refunded on Research respec, unless the player is entering a study		// 研究类型允许玩家进入一个研究室，并且在重置研究时会返还，除非玩家正在进入一个研究室
*/
/*
description					the effect of the research, accounting for boosts		// 研究的效果，计入增益
adjacent_req				 adjacent research. at least one research in this array must be purchased in order to purchase the research. row 1 research is always purchasable		// 相邻需求。至少需要购买此数组中的一项研究才能购买该研究。第1行的研究总是可购买
condition						a condition that must be fulfilled to purchase the research		// 购买研究必须满足的条件
visibility					 a condition that must be fulfilled for the research to appear (besides having purchased a research from the previous row at least once)		// 研究出现必须满足的条件（除了已购买上一行的至少一项研究之外）
type								 whether the research is normal, permanent or a study		// 研究是常规类型、永久类型还是研究室类型
basecost						 the base cost		// 基础成本
icon								 the text inside the research box		// 研究框内的文本
group								the group of the research		// 研究所属的组
*/
const researchList = {
	antimatter:{},
	finality:	{ // 0 = adjacent requirements, 1-12 = research		// 0 = 相邻需求, 1-12 = 研究
...
const researchGroupList = {
	energy:{label:"能量",description:"每个拥有的能量研究使所有其他能量研究的成本翻倍。",color:{light:"var(--energy)",dark:"0,68,68"},icon:"E"},
	stardust:{label:"星尘",get description(){return "每个拥有的星尘研究使所有其他星尘研究的成本翻倍。"+((g.studyCompletions[4]===4)?"":(" 如果你的星尘研究数量大于等于你的研究IV完成数("+g.studyCompletions[4]+")，它们的成本会进一步增加。"))},color:{light:"#ff9900",dark:"51,34,0"},icon:"S"},
	light:{label:"色度",get description(){return "每个拥有的色度研究使同一行中所有其他色度研究的成本乘以"+(g.achievement[713]?achievement(713).effectFormat(achievement(713).effect()):"4")+"。"},color:{light:"#ffff00",dark:"51,51,0"},icon:"C"},
	lightaugment:{label:"光子",description:"每个光子研究使所有其他光子研究的成本乘以已拥有的数量，并增加购买它们所需的光子流明要求。",color:{light:"#cccc00",dark:"34,34,0"},icon:"C<sup>2</sup>"},
	study5a:{label:"理论",color:{light:"#00aaaa",dark:"0,40,40"},icon:"T"},
	study5b:{label:"实践",get description(){return "拥有比"+researchGroupList.study5a.label+"研究("+ownedResearchInGroup("study5a").length+")更多的"+researchGroupList.study5b.label+"研究("+ownedResearchInGroup("study5b").length+")会大幅增加其成本"},color:{light:"#009999",dark:"0,34,34"},icon:"P"},
	time:{label:"时间",get description(){return "你最多可以购买"+g.studyCompletions[6]+"个时间研究（等于研究VI完成数）"},color:{light:"var(--time)",dark:"0,51,0"},icon:"t"},
	spatialsynergism:{label:"空间协同",get description(){return "你最多可以从此组购买"+achievement.perAchievementReward[8].currentVal+"个研究"},color:{light:"var(--wormhole_text)",dark:"0,0,51"},icon:"SS"},
	study7:{label:"水晶",color:{light:"#009900",dark:"0,34,0"},icon:"S"},
	mastery:{label:"精通",get description(){return "拥有的精通研究数量超过研究VIII完成数("+g.studyCompletions[8]+")时，每个超额研究会使所有精通效果减弱33%"},color:{light:"var(--mastery)",dark:"51,0,34"},icon:"M"},
	prismal:{label:"棱镜",get description(){return "你最多可以购买"+prismaticUpgrades.prismLab.eff()+"个棱镜研究"},color:{light:"#00ff99",dark:"0,51,34"},icon:"P"},
	luck:{label:"幸运",get description(){return "每个幸运研究使所有其他幸运研究的效果降低"+(g.achievement[819]?c.d7.mul(achievement(819).effect()).noLeadFormat(3):"7")+"%"},color:{light:"var(--luck)",dark:"17,51,34"},icon:"L"},
	antimatter:{label:"反物质",get description(){return "每个反物质研究使所有其他反物质研究的效果降低"+(g.achievement[819]?c.d9.mul(achievement(819).effect()).noLeadFormat(3):"9")+"%"},color:{light:"var(--antimatter)",dark:"34,0,0"},icon:"A"},
	...(()=>{
		let out = {}
		for (let i=1;i<13;i++) out["finality"+i] = {label:"终末-"+roman(i),description:"每个终末-"+roman(i)+"研究使所有其他终末-"+roman(i)+"研究的成本乘以"+(0.05*i**2+0.15*i+1).toFixed(1),color:{light:"rgb("+Math.round(51*(34-i)/11)+",0,"+Math.round(85*(34-i)/11)+")",dark:Math.round(51*(34-i)/55)+",0,"+Math.round(85*(34-i)/55)},icon:"F<sub>"+i+"</sub>"}
		return out
	})(),
	binding:{label:"邮件破坏者",description:"每个拥有的邮件破坏者研究使所有其他邮件破坏者研究的成本翻倍。",color:{light:"var(--binding)",dark:"47,36,25"},icon:"B"}
}
const research = (function(){
	function studyReq(i,num) {return {check:function(){return g.studyCompletions[i]>=num},text:function(){return g.studyCompletions[i]+" / "+num+" 研究"+((i===10)?"的研究":roman(i))+"完成数"}}}
	function totalStudyReq(num) {return {check:function(){return g.studyCompletions.sum()>=num},text:function(){return g.studyCompletions.sum()+" / "+num+" 总研究完成数"}}}
	function unconnectedResearchReq(id) {return {check:function(){return g.research[id]},text:function(){return "已拥有研究 "+researchOut(id)}}}
	function lumenReq(index,num) {return {check:function(){return g.lumens[index].gte(num)},text:function(){return g.lumens[index].format()+" / "+num.format()+" "+lightNames[index]+" 流明"}}}
	function lightAugmentReq(i) {
		return {
			...
			text:function(){return g.lumens[i].format()+" / "+this.req().format()+" "+lightNames[i]+" 流明"}
		}
	}
	function studyVResearch(pos,comp,resInt,resOut,amount) {
		return {
			description:function(){return "所有研究价格降低"+percentOrDiv(researchEffect(researchRow(pos),researchCol(pos)))+""},
			adjacent_req:[],
	...
	function timeResearchDesc(row,col,res){return function(){let eff = researchEffect(row,col);return "在当前虫洞中每秒获得"+(eff.gte(c.d0_01)?(eff.mul(c.e2).noLeadFormat(2)+"% "+res):("1% "+res+" 每 "+eff.mul(c.e2).max(c.minvalue).recip().noLeadFormat(2)+" 秒"))+(g.research.r17_8?("，然后将此乘数提升到"+researchEffect(17,8).noLeadFormat(4)+"次方"):"")+" (当前: "+(g.research.r17_8?arrowJoin(percentOrMult(eff.mul(g.truetimeThisWormholeReset).add(c.d1),2,true),percentOrMult(eff.mul(g.truetimeThisWormholeReset).add(c.d1).pow(researchEffect(17,8)),2,true)):percentOrMult(eff.mul(g.truetimeThisWormholeReset).add(c.d1),2,true))+")"}}
	function prismalResearch(num) {
		...
		return {
			...
			description:function(){return "棱镜获取速度加快"+numOrFormula(id)+"倍 (基于"+lightNames[num]+"流明)"},
	...
	function particleLab2Condition(req){return (req===0)?[]:[{text:function(){return study13.rewardLabel("particleLab2")+" 等级 "+study13.rewardLevels.particleLab2+" / "+req},check:function(){return study13.rewardLevels.particleLab2>=req}}]}
	function luckResearch(type,upg,pos,resIcon,particleLab2Req=0) {
		luckUpgrades[type][upg].luckResearch = pos // 懒得手动更新幸运升级数据
		...
		return {
			description:function(){let eff=researchEffect(row,col);return "为"+toTitleCase(type)+" "+luckUpgrades[type][upg].name+"增加"+eff.noLeadFormat(3)+"个免费等级"},
	...
	function antimatterRes1(type,pos,particleLab2Req=0) {
		...
		return {
			description:function(){return "反"+type+"维度提升效果增强"+percentOrMult(researchEffect(row,col),2,false)+""},
			adjacent_req:adjacent_req,
			condition:particleLab2Condition(particleLab2Req),
	...
	function antimatterRes2(type,pos) {
		...
		return {
			...
			description:function(){return "获得"+numOrFormula("r"+row+"_14")+"个免费反"+type+"轴 (基于已购买数量)"},
			adjacent_req:adjacent_req,
			condition:[],
			visibility:function(){return true},
			type:"normal",
	...
	return {
		r1_3:{
			description:function(){return "每拥有一个普通轴，奇异物质获取增加"+researchEffect(1,3).formatFrom1(2)+"倍 (当前总计: "+researchEffect(1,3).pow(stat.totalNormalAxis).format(2)+"倍)";},
			adjacent_req:[],
			condition:[], 
			visibility:function(){return true;},
			type:"normal",
		...
		r1_5:studyVResearch("r1_5",1,"exoticmatter","奇异物质",c.ee8),
		r1_6:studyVResearch("r1_6",3,"darkmatter","暗物质",N("e2e6")),
		r1_8:{
			description:function(){return "前七个普通轴的效果乘以"+researchEffect(1,8).formatFrom1(2)+"";},
			adjacent_req:[],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r1_10:studyVResearch("r1_10",4,"masteryPower","精通能量",c.ee4),
		r1_11:studyVResearch("r1_11",2,"stardust","星尘",c.ee5),
		r1_13:{
			description:function(){return "每拥有一个暗轴，暗物质获取增加"+researchEffect(1,13).formatFrom1(2)+"倍 (当前总计: "+researchEffect(1,13).pow(stat.totalDarkAxis).format(2)+"倍)";},
			adjacent_req:[],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r2_2:{
			description:function(){return "每拥有一个X轴，X轴效果增加"+researchEffect(2,2).noLeadFormat(2)+"% (当前总计: "+researchEffect(2,2).mul(g.XAxis).noLeadFormat(2)+"%)";},
			adjacent_req:["r1_3"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r2_4:{
			description:function(){return "在此虫洞中每秒增加X轴效果"+researchEffect(2,4).noLeadFormat(2)+"% (当前总计: "+researchEffect(2,4).mul(g.truetimeThisWormholeReset).format(2)+"%)";},
			adjacent_req:["r1_3"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r2_6:{
			...
			description:function(){return "从暗物质中获得"+numOrFormula("r2_6")+"%更多免费轴 (基于总发现数)"},
		...
		r2_7:{
			description:function(){return "每OoM的空间能量增加X轴效果"+researchEffect(2,7).noLeadFormat(2)+"% (当前总计: "+researchEffect(2,7).mul(g.spatialEnergy.log10()).noLeadFormat(2)+"%)";},
			adjacent_req:["r1_8"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r2_8:{
			adjacent_req:["r1_8"],
			condition:[{check:function(){return g.knowledge.gt(studies[5].unlockReq())},text:function(){return g.knowledge.format(2)+" / "+studies[5].unlockReq().format(2)+" 知识"}},unconnectedResearchReq("r11_8")],
		...
		r2_9:{
			description:function(){return "每拥有一个暗X轴，X轴效果增加"+researchEffect(2,9).noLeadFormat(2)+"% (当前总计: "+researchEffect(2,9).mul(g.darkXAxis).noLeadFormat(2)+"%)";},
			adjacent_req:["r1_8"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r2_10:{
			...
			description:function(){return "星尘获取乘以(霍金辐射)<sup>"+numOrFormula("r2_10")+"</sup>，基于总发现数 (当前相当于"+g.hawkingradiation.max(c.d1).pow(researchEffect(2,10)).format(2)+"倍星尘)"},
		...
		r2_11:{
			description:function(){return "<b>在研究XIII中</b><br>绑定234效果减弱"+percentOrDiv(researchEffect(2,11).i)+"<br><br><b>在研究XIII外</b><br>获得"+researchEffect(2,11).o.format(2)+"倍精通能量"},
			adjacent_req:["r1_10","r1_11"],
		...
		r2_12:{
			description:function(){return "每总发现数增加X轴效果"+researchEffect(2,12).noLeadFormat(2)+"% (当前总计: "+researchEffect(2,12).mul(g.totalDiscoveries).noLeadFormat(2)+"%)";},
			adjacent_req:["r1_13"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r2_14:{
			...
			description:function(){return "将X轴效果提升到"+numOrFormula("r2_14")+"次方 (基于拥有的X轴减少)";},
			adjacent_req:["r1_13"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r3_2:{
			description:function(){return "获得"+researchEffect(3,2).noLeadFormat(2)+"个免费S轴";},
			adjacent_req:["r2_2"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r3_5:{
			description:function(){return "将S轴成本提升到"+researchEffect(3,5).noLeadFormat(3)+"次方";},
			adjacent_req:["r2_4"],
			condition:[],
			visibility:function(){return true;}, 
			type:"normal",
		...
		r3_6:{
			description:function(){return "每拥有一个暗S轴获得"+researchEffect(3,6).noLeadFormat(2)+"个免费暗X轴 (当前总计: "+researchEffect(3,6).mul(g.darkSAxis).noLeadFormat(2)+")";},
		...
		r3_8:{
			...
			description:function(){return "知识获取乘以"+numOrFormula("r3_8")+" (基于总发现数)"},
			adjacent_req:["r2_8"],
		...
		r3_10:{
			description:function(){return "每拥有一个暗星获得"+researchEffect(3,10).noLeadFormat(2)+"个免费暗X轴 (当前总计: "+researchEffect(3,10).mul(g.darkstars).noLeadFormat(2)+")";},
		...
		r3_11:{
			description:function(){return "将暗S轴成本提升到"+researchEffect(3,11).noLeadFormat(3)+"次方";},
		...
		r3_14:{
			description:function(){return "获得"+researchEffect(3,14).noLeadFormat(2)+"个免费暗S轴";},
			adjacent_req:["r2_14"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r4_1:{
			description:function(){return "暗能量增加速度加快"+researchEffect(4,1).noLeadFormat(2)+"倍";},
			adjacent_req:["r3_2"],
			condition:[{check:function(){return achievement.ownedInTier(5)>=15},text:function(){return achievement.ownedInTier(5)+" / 15 个第5级成就"}}],
		...
		r4_2:{
			description:function(){return "星体能量增加速度加快"+researchEffect(4,2).noLeadFormat(2)+"倍";},
			adjacent_req:["r3_2"],
			condition:[{check:function(){return achievement.ownedInTier(5)>=15},text:function(){return achievement.ownedInTier(5)+" / 15 个第5级成就"}}],
			visibility:function(){return achievement.ownedInTier(5)>=15;},
			type:"normal",
		...
		r4_3:{
			description:function(){return "引力能量增加速度加快"+researchEffect(4,3).noLeadFormat(2)+"倍";},
			adjacent_req:["r3_2"],
			condition:[{check:function(){return achievement.ownedInTier(5)>=15},text:function(){return achievement.ownedInTier(5)+" / 15 个第5级成就"}}],
			visibility:function(){return achievement.ownedInTier(5)>=15;},
			type:"normal",
		...
		r4_6:{
			description:function(){return "S轴效果"+formulaFormat.exp(researchPower(4,6))+"影响精通11 (当前总计: ^"+researchEffect(4,6).format(4)+")";},
		...
		r4_7:{
			...
			description:function(){return "色度获取乘以"+numOrFormula("r4_7")+" (基于总发现数)"},
			adjacent_req:["r2_8"],
			condition:[studyReq(5,1)],
			visibility:function(){return g.studyCompletions[5]>0},
			type:"normal",
		...
		r4_9:{
			...
			description:function(){return "霍金辐射获取乘以"+numOrFormula("r4_9")+" (基于总发现数)"},
			adjacent_req:["r2_8"],
			condition:[studyReq(5,1)],
			visibility:function(){return g.studyCompletions[5]>0},
			type:"normal",
		...
		r4_10:{
			description:function(){return "S轴效果"+formulaFormat.exp(researchPower(4,10))+"影响精通12 (当前总计: ^"+researchEffect(4,10).format(4)+")";},
		...
		r4_13:{
			description:function(){return "空间能量增加速度加快"+researchEffect(4,13).noLeadFormat(2)+"倍";},
			adjacent_req:["r3_14"],
			condition:[{check:function(){return achievement.ownedInTier(5)>=15},text:function(){return achievement.ownedInTier(5)+" / 15 个第5级成就"}}],
			visibility:function(){return achievement.ownedInTier(5)>=15;},
			type:"normal",
		...
		r4_14:{
			description:function(){return "神经能量增加速度加快"+researchEffect(4,14).noLeadFormat(2)+"倍";},
			adjacent_req:["r3_14"],
			condition:[{check:function(){return achievement.ownedInTier(5)>=15},text:function(){return achievement.ownedInTier(5)+" / 15 个第5级成就"}}],
			visibility:function(){return achievement.ownedInTier(5)>=15;},
			type:"normal",
		...
		r4_15:{
			description:function(){return "元能量增加速度加快"+researchEffect(4,15).noLeadFormat(2)+"倍";},
			adjacent_req:["r3_14"],
			condition:[{check:function(){return achievement.ownedInTier(5)>=15},text:function(){return achievement.ownedInTier(5)+" / 15 个第5级成就"}}],
			visibility:function(){return achievement.ownedInTier(5)>=15;},
			type:"normal",
		...
		r5_1:{
			description:function(){return "暗能量效果"+formulaFormat.exp(researchEffect(5,1))+"提升T轴效果 (当前: ^"+stat.darkEnergyEffect.pow(researchEffect(5,1)).format(4)+")";},
		...
		r5_2:{
			description:function(){return "星体能量效果"+formulaFormat.exp(researchEffect(5,2))+"提升U轴效果 (当前: ^"+stat.stelliferousEnergyEffect.pow(researchEffect(5,2)).format(4)+")";},
			adjacent_req:["r4_1","r4_2","r4_3"],
			condition:[],
			visibility:function(){return achievement.ownedInTier(5)>=15;},
			type:"normal",
		...
		r5_3:{
			description:function(){return "引力能量效果"+formulaFormat.exp(researchEffect(5,3))+"提升暗U轴效果 (当前: ^"+stat.gravitationalEnergyEffect.pow(researchEffect(5,3)).format(4)+")";},
			adjacent_req:["r4_1","r4_2","r4_3"],
			condition:[],
			visibility:function(){return achievement.ownedInTier(5)>=15;},
			type:"normal",
		...
		r5_7:{
			adjacent_req:["r4_6"],
			condition:[{check:function(){return stat.totalDarkAxis.gte(studies[1].unlockReq())},text:function(){return stat.totalDarkAxis.format(0)+" / "+studies[1].unlockReq().format()+" 总暗轴"}}],
			visibility:function(){return true;},
			type:"study",
			basecost:c.d12,
		...
		r5_8:{
			...
			description:function(){return "其他实践研究效果增强"+numOrFormula("r5_8")+(researchEffect(5,8).gte(c.d10)?"倍":"%")+" (基于总发现数)"},
		...
		r5_9:{
			adjacent_req:["r4_10"],
			condition:[{check:function(){return g.stardust.gte(studies[2].unlockReq())},text:function(){return g.stardust.format()+" / "+studies[2].unlockReq().format()+" 星尘"}}],
			visibility:function(){return true;},
			type:"study",
			basecost:c.d12,
		...
		r5_13:{
			description:function(){return "空间能量效果"+formulaFormat.exp(researchEffect(5,13))+"提升第2行精通效果 (当前: ^"+stat.spatialEnergyEffect.pow(researchEffect(5,13)).format(4)+")";},
		...
		r5_14:{
			description:function(){return "神经能量效果"+formulaFormat.exp(researchEffect(5,14))+"提升星尘提升7效果 (当前: ^"+stat.neuralEnergyEffect.pow(researchEffect(5,14)).format(4)+")";},
			adjacent_req:["r4_13","r4_14","r4_15"],
			condition:[],
			visibility:function(){return achievement.ownedInTier(5)>=15;},
			type:"normal",
		...
		r5_15:{
			description:function(){return "元能量效果"+formulaFormat.exp(researchEffect(5,15))+"乘以时间速度 (当前: ×"+stat.metaEnergyEffect.pow(researchEffect(5,15)).format(4)+")";},
			adjacent_req:["r4_13","r4_14","r4_15"],
			condition:[],
			visibility:function(){return achievement.ownedInTier(5)>=15;},
			type:"normal",
		...
		r6_1:{
			description:function(){return "暗能量效果"+formulaFormat.exp(researchEffect(6,1))+"提升Z轴效果 (当前: ^"+stat.darkEnergyEffect.pow(researchEffect(6,1)).format(4)+")";},
		...
		r6_2:{
			description:function(){return "星体能量效果"+formulaFormat.exp(researchEffect(6,2))+"降低星体成本 (当前: ^"+stat.stelliferousEnergyEffect.pow(researchEffect(6,2).mul(c.dm1)).format(3)+")";},
			adjacent_req:["r5_1","r5_2","r5_3"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r6_3:{
			description:function(){return "引力能量效果"+formulaFormat.exp(researchEffect(6,3))+"除以暗星成本 (当前: ÷"+stat.gravitationalEnergyEffect.pow(researchEffect(6,3)).format(4)+")";},
			adjacent_req:["r5_1","r5_2","r5_3"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r6_5:{
			description:function(){return "每完成一个成就，精通能量获取加速"+researchEffect(6,5).mul(c.e2).noLeadFormat(2)+"% (当前总计: "+[researchEffect(6,5),totalAchievements,c.e2].productDecimals().noLeadFormat(2)+"%)";},
			adjacent_req:["r6_6"],
		...
		r6_6: {
			description:function(){return "每完成一个成就，时间速度提高"+researchEffect(6,6).mul(c.e2).noLeadFormat(2)+"% (当前总计: "+[researchEffect(6,6),totalAchievements,c.e2].productDecimals().noLeadFormat(2)+"%)";},
		...
		r6_8: {
			description:function(){return "每完成一个成就，每个已购买的星体使霍金辐射获取提高"+researchEffect(6,8).mul(c.e2).noLeadFormat(2)+"% (当前总计: "+percentOrMult([researchEffect(6,8),totalAchievements,g.stars].productDecimals().add(c.d1),2,true)+")";},
		...
		r6_9: {
			description:function(){return "解锁一个隐藏成就";},
			adjacent_req:[],
			condition:[],
		...
		r6_10: {
			description:function(){return "第7行星体效果增强"+researchEffect(6,10).noLeadFormat(3)+"%";},
		...
		r6_11: {
			description:function(){return "每个分配的星体使该行的精通效果增强"+researchEffect(6,11).noLeadFormat(3)+"%";},
			adjacent_req:["r6_10"],
		...
		r6_13: {
			description:function(){return "空间能量效果"+formulaFormat.exp(researchEffect(6,13))+"提升V轴效果 (当前: ^"+stat.spatialEnergyEffect.pow(researchEffect(6,13)).format(4)+")";},
		...
		r6_14: {
			description:function(){return "神经能量效果"+formulaFormat.exp(researchEffect(6,14))+"提升暗W轴效果 (当前: ^"+stat.neuralEnergyEffect.pow(researchEffect(6,14)).format(4)+")";},
			adjacent_req:["r5_13","r5_14","r5_15"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r6_15: {
			description:function(){return "元能量效果"+formulaFormat.exp(researchEffect(6,15))+"提升霍金辐射 (当前: ×"+stat.metaEnergyEffect.pow(researchEffect(6,15)).format(4)+")";},
			adjacent_req:["r5_13","r5_14","r5_15"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
	...
	r7_1: {
			description:function(){return "暗能量效果"+formulaFormat.exp(researchEffect(7,1))+"影响星体能量和元能量获取 (当前: ^"+stat.darkEnergyEffect.pow(researchEffect(7,1)).format(2)+")";},
		...
		r7_2: {
			description:function(){return "星体能量效果"+formulaFormat.exp(researchEffect(7,2))+"影响空间能量和神经能量获取 (当前: ^"+stat.stelliferousEnergyEffect.pow(researchEffect(7,2)).format(2)+")";},
			adjacent_req:["r6_1","r6_2","r6_3"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r7_3: {
			description:function(){return "引力能量效果"+formulaFormat.exp(researchEffect(7,3))+"影响空间能量和元能量获取 (当前: ^"+stat.gravitationalEnergyEffect.pow(researchEffect(7,3)).format(2)+")";},
			adjacent_req:["r6_1","r6_2","r6_3"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r7_5: {
			description:function(){return "每完成一个成就，知识获取加速"+researchEffect(7,5).mul(c.e2).noLeadFormat(2)+"% (当前总计: "+[researchEffect(7,5),totalAchievements,100].productDecimals().noLeadFormat(2)+"%)";},
			adjacent_req:["r6_5"],
		...
		r7_8: {
			...
			description:function(){return "星体成本增长速度降低"+numOrFormula("r7_8")+"% (基于拥有的成就数)";},
			adjacent_req:["r6_8"],
		...
		r7_11: {
			description:function(){return "每个已购买的暗星将普通星体成本提升到"+researchEffect(7,11).formatFrom1(2)+"次方 (当前总计: ^"+researchEffect(7,11).pow(g.darkstars).format(4)+")";},
			adjacent_req:["r6_11"],
		...
		r7_13: {
			description:function(){return "空间能量效果"+formulaFormat.exp(researchEffect(7,13))+"影响暗能量和引力能量获取 (当前: ^"+stat.spatialEnergyEffect.pow(researchEffect(7,13)).format(2)+")";},
		...
		r7_14: {
			description:function(){return "神经能量效果"+formulaFormat.exp(researchEffect(7,14))+"影响星体能量和引力能量获取 (当前: ^"+stat.neuralEnergyEffect.pow(researchEffect(7,14)).format(2)+")";},
			adjacent_req:["r6_13","r6_14","r6_15"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r7_15: {
			description:function(){return "元能量效果"+formulaFormat.exp(researchEffect(7,15))+"影响暗能量和神经能量获取 (当前: ^"+stat.metaEnergyEffect.pow(researchEffect(7,15)).format(2)+")";},
			adjacent_req:["r6_13","r6_14","r6_15"],
			condition:[],
			visibility:function(){return true;},
			type:"normal",
		...
		r8_2: {
			description:function(){return "霍金辐射乘以时间速度"+formulaFormat.exp(researchEffect(8,2))+" (当前: ×"+stat.tickspeed.pow(researchEffect(8,2)).format(2)+")";},
		...
		r8_5: {
			description:function(){return "每完成一个成就，能量获取加速"+researchEffect(8,5).mul(c.e2).noLeadFormat(2)+"% (当前总计: "+[researchEffect(8,5),totalAchievements,100].productDecimals().noLeadFormat(2)+"%)";},
			adjacent_req:["r7_5"],
		...
		r8_8: {
			description:function(){return "解锁光"},
			adjacent_req:["r7_8"],
		...
		r8_11: {
			description:function(){return "第1行研究效果增强"+researchEffect(8,11).noLeadFormat(2)+"% 每购买一个星体 (当前总计: "+researchEffect(8,11).mul(research.r8_11.starCount()).noLeadFormat(2)+"%)";},
			adjacent_req:["r7_11"],
		...
		r8_14: {
			description:function(){return "星体成本偏移"+researchEffect(8,14).noLeadFormat(2)+"个星体";},
		...
		r9_1: {
			description:function(){return "心智能量获取加速"+researchEffect(9,1).noLeadFormat(2)+"倍";},
			adjacent_req:["r9_2"],
		...
		r9_2: {
			adjacent_req:["r8_2"],
			condition:[{check:function(){return energyPerSec(0).gt(studies[3].unlockReq())},text:function(){return energyPerSec(0).format(2)+" / "+BEformat(studies[3].unlockReq())+" 暗能量每秒"}},totalStudyReq(6)],
		...
		r9_3: {
			description:function(){return "真空能量获取加速"+researchEffect(9,3).noLeadFormat(2)+"倍";},
			adjacent_req:["r9_2"],
		...
		r9_5:{
			description:function(){return "研究6-5、6-6、7-5和8-5效果乘性增强"+percentOrMult(researchEffect(9,5),2,false)+" 每完成一个成就 (当前总计: "+percentOrMult(researchEffect(9,5).pow(totalAchievements),2,true)+")"},
			adjacent_req:["r8_5"],
		...
		...(()=>{
			...
			for (let i=0;i<3;i++) out.push(["r9_"+(i+7),{
				...
				description:function(){return "色度获取加速"+numOrFormula("r9_"+(i+7))+"倍 (基于"+lightNames[i]+"流明)"},
				adjacent_req:["r8_8"],
		...
		r9_11:{
			description:function(){return "为研究8-11的效果增加"+researchEffect(9,11).noLeadFormat(2)+"个星体 每拥有一个星系 (当前: "+researchEffect(9,11).mul(g.galaxies).noLeadFormat(2)+")"},
			adjacent_req:["r8_11"],
			condition:[studyReq(10,2)],
			visibility:function(){return g.studyCompletions[10]>1},
			type:"normal",
		...
		r9_13:{
			...
			description:function(){return "星尘提升能量获取 (当前: "+numOrFormula("r9_13")+"倍)"},
			adjacent_req:["r9_14"],
		...
		r9_14: {
			adjacent_req:["r8_14"],
			condition:[{check:function(){return g.stardust.gt(studies[4].unlockReq())},text:function(){return g.stardust.format()+" / "+studies[4].unlockReq().format()+" 星尘"}},{check:function(){return effectiveStardustUpgrades()<7},text:function(){return "星尘升级不超过"+effectiveStardustUpgrades()+" / 6个"},joinWithPrevious:true},totalStudyReq(6)],
			visibility:function(){return g.studyCompletions.sum()>5;},
			type:"study",
			basecost:N(1200),
		...
		r9_15:{
			...
			description:function(){return "星尘提升色度获取 (当前: "+numOrFormula("r9_15")+"倍)"},
			adjacent_req:["r9_14"],
			condition:[studyReq(4,1)],
			visibility:function(){return g.studyCompletions[4]>0},
			type:"normal",
		...
		r10_1: {
			description:function(){return "时间能量获取加速"+researchEffect(10,1).noLeadFormat(2)+"倍";},
			adjacent_req:["r9_2"],
		...
		r10_2:{
			description:function(){return "所有能量效果增强"+researchEffect(10,2).sub(c.d1).mul(c.e2).noLeadFormat(2)+"%"},
		...
		r10_3: {
			description:function(){return "维度能量获取加速"+researchEffect(10,3).noLeadFormat(2)+"倍";},
			adjacent_req:["r9_2"],
		...
		r10_5: {
			description:function(){return "解锁另外三种颜色的光"},
			adjacent_req:["r9_5","r9_7"],
			condition:[{check:function(){return stat.chromaPerSec.gte(c.d75)},text:function(){return stat.chromaPerSec.format(2)+" / 75 色度每秒"}}],
			visibility:function(){return true},
			type:"permanent",
			basecost:N(600),
		...
		...(()=>{
			...
			for (let i=0;i<3;i++) out.push(["r10_"+(i+7),{
				...
				description:function(){return "色度获取加速"+numOrFormula("r10_"+(i+7))+"倍 (基于"+lightNames[i+3]+"色度)"},
				adjacent_req:["r9_"+(i+7)],
				condition:[{check:function(){return g.chroma[i+3].gt(c.e8)},text:function(){return g.chroma[i+3].format()+" / "+BEformat(c.e8)+" "+lightNames[i+3]+" 色度"}},unconnectedResearchReq("r10_5")],
		...
		r10_11: {
			description:function(){return "解锁精通104"},
			adjacent_req:["r9_9","r9_11"],
			condition:[{check:function(){return g.masteryPower.gt(c.ee3)},text:function(){return g.masteryPower.format()+" / "+BEformat(c.ee3)+" 精通能量"}}],
			visibility:function(){return true},
			type:"permanent",
			basecost:N(600),
		...
		r10_13:{
			...
			description:function(){return "星尘提升霍金辐射获取 (当前: "+numOrFormula("r10_13")+"倍)"},
			adjacent_req:["r9_14"],
			condition:[studyReq(4,1)],
			visibility:function(){return g.studyCompletions[4]>0},
			type:"normal",
		...
		r10_14:{
			description:function(){return "星尘提升4增强"+researchEffect(10,14).sub(c.d1).mul(c.e2).noLeadFormat(2)+"%"},
		...
		r10_15:{
			...
			description:function(){return "基于星尘获得免费暗星 (当前: "+numOrFormula("r10_15")+")"},
			adjacent_req:["r9_14"],
			condition:[studyReq(4,1)],
			visibility:function(){return g.studyCompletions[4]>0},
			type:"normal",
		...
		r11_5:{
			description:function(){return "移除"+achievement.label(412)+"奖励的软上限，并使其基础值乘性增强"+percentOrMult(researchEffect(11,5),2,false)+" 每完成一个成就 (预期效果: "+arrowJoin(achievement(412).effect(false).format(2),achievement(412).effect(true).format(2))+")"},
			adjacent_req:["r10_5"],
			condition:[studyReq(10,1)],
			visibility:function(){return g.studyCompletions[10]>0},
			type:"normal",
		...
		r11_8:{
			description:function(){return "解锁另外两种颜色的光"},
		...
		r11_11:{
			description:function(){return "第7行星体效果上限提升"+researchEffect(11,11).noLeadFormat(3)+"% 每个星系 (总计: "+researchEffect(11,11).mul(g.galaxies).noLeadFormat(3)+"%)"},
			adjacent_req:["r10_11"],
			condition:[studyReq(10,2)],
			visibility:function(){return g.studyCompletions[10]>1},
			type:"normal",
		...
		r12_8:{
			description:function(){return "解锁星系"},
			adjacent_req:["r11_8"],
			condition:[{check:function(){return g.stars>=60},text:function(){return g.stars+" / 60 星体"}},{check:function(){return g.ach519possible},text:function(){return "在当前宇宙中未分配任何星体"},joinWithPrevious:true}],
		...
		r13_5:{
			...
			description:function(){return "黄色流明减弱第二个星系惩罚 (当前: ^"+numOrFormula("r13_5")+")"},
			adjacent_req:["r13_7"],
		...
		r13_7:{
			...
			description:function(){return "白色流明进一步降低星体成本 (当前: ^"+numOrFormula("r13_7")+")"},
		...
		r13_8:{
			...
			description:function(){return "色度获取乘以"+numOrFormula("r13_8")+"倍 (基于黑色和白色流明)"},
		...
		r13_9:{
			...
			description:function(){return "黑色流明进一步降低色度成本 (当前: ÷"+numOrFormula("r13_9")+")"},
		...
		r13_11:{
			...
			description:function(){return "红色流明提升可被3整除的星尘提升 (当前: "+numOrFormula("r13_11")+"%)"},
			adjacent_req:["r13_9"],
		...
		r14_6:{
			...
			description:function(){return "绿色流明提升时间速度 (当前: "+numOrFormula("r14_6")+")"},
			adjacent_req:["r13_7"],
		...
		r14_8:{
			...
			description:function(){return "知识获取乘以"+numOrFormula("r14_8")+"倍 (基于青色、品红色和黄色流明)"},
			adjacent_req:["r13_8"],
			condition:[],
			visibility:function(){return true},
			type:"normal",
		...
		r14_10:{
			...
			description:function(){return "品红色流明提升暗Y轴 (当前: ^"+numOrFormula("r14_10")+")"},
			adjacent_req:["r13_9"],
		...
		...(()=>{
			...
			for (let i of [5,11]) out["r15_"+i] = {
				...
				description:function(){return (i===11?"黑色":"白色")+"流明进一步提升研究13-8的效果 (当前: "+numOrFormula("r15_"+i)+")"},
				adjacent_req:(i===11)?["r13_11","r14_10","r15_9"]:["r13_5","r14_6","r15_7"],
				condition:[{check:function(){return achievement.ownedInTier(7)>=7},text:function(){return achievement.ownedInTier(7)+" / 7 个第7级成就"}}],
				visibility:function(){return true},
				type:"normal",
				basecost:N(1760),
...
r15_7:{
	...
	description:function(){return "青色流明提升能量获取 (当前: "+numOrFormula("r15_7")+"×)"},
	adjacent_req:["r13_7"],
...
r15_8:{
	...
	description:function(){return "霍金辐射获取乘以 "+numOrFormula("r15_8")+"× (基于红、绿、蓝流明)"},
	adjacent_req:["r14_8"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r15_9:{
	...
	description:function(){return "蓝色流明提升霍金辐射获取 (当前: "+numOrFormula("r15_9")+"×)"},
	adjacent_req:["r13_9"],
...
...(()=>{
	...
	for (let i=0;i<8;i++) {
		...
		out[pos(i+1,false)] = {
			description:function(){return axisCodes[i]+"轴成本提升到 "+researchEffect(researchRow(pos(i+1,false)),researchCol(pos(i+1,false))).noLeadFormat(3)+" 次方"},
			adjacent_req:[pos(i,false)],
			icon:icon[axisCodes[i]+"Axis"]+classes.exoticmatter("$")+icon.minus,
			...common
		}
		out[pos(i+1,true)] = {
			description:function(){return "暗"+axisCodes[i]+"轴成本提升到 "+researchEffect(researchRow(pos(i+1,true)),researchCol(pos(i+1,true))).noLeadFormat(3)+" 次方"},
...
r16_4:{
	description:function(){return "S轴效果"+formulaFormat.exp(researchEffect(16,4))+" 影响Z轴效果"},
...
r16_6:{
	description:timeResearchDesc(16,6,"色度"),
	adjacent_req:["r16_7"],
...
r16_7:{
	description:timeResearchDesc(16,7,"霍金辐射"),
	adjacent_req:["r16_8"],
...
r16_8:{
	adjacent_req:["r15_8"],
	condition:[{check:function(){return stat.tickspeed.gt(studies[6].unlockReq())},text:function(){return stat.tickspeed.format(3)+" / "+studies[6].unlockReq().format()+"× 时间速度"}}],
	visibility:function(){return true;},
	type:"study",
	basecost:N(1440),
...
r16_9:{
	description:timeResearchDesc(16,9,"暗X轴效果"),
	adjacent_req:["r16_8"],
	condition:[studyReq(6,1)],
	visibility:function(){return g.studyCompletions[6]>=1},
	type:"normal",
...
r16_10:{
	description:timeResearchDesc(16,10,"W轴效果"),
	adjacent_req:["r16_9"],
	condition:[studyReq(6,2)],
	visibility:function(){return g.studyCompletions[6]>=2},
	type:"normal",
...
r16_12:{
	description:function(){return "暗星便宜 "+researchEffect(16,12).noLeadFormat(2)+"×"},
...
...(()=>{
	...
	for (let i1=1;i1<8;i1++) for (let i2=1;i2<=i1;i2++) for (let isDark of [true,false]) {
		...
		let a1 = axisCodes[i1]    // 基于此轴的成本被降低
		let a2 = axisCodes[i2-1]  // 此轴的成本被降低
		out["r"+row+"_"+col] = {
			description:function(){let eff=researchEffect(row,col);return (isDark?"暗":"")+a2+"轴成本降低到 1 + ["+(isDark?"暗":"")+a1+"轴]"+formulaFormat.mult(eff)+" 次方根 (当前: "+this.value().noLeadFormat(4)+(this.value().eq(c.d1)?"次":"次")+")"},
...
r17_8:{
	...
	description:function(){return "灰色流明强化所有时间研究 (当前: ^"+numOrFormula("r17_8")+")"},
...
r18_8:{
	...
	condition:[{check:function(){return g.masteryPower.gt(studies[8].unlockReq())},text:function(){return g.masteryPower.format()+" / "+studies[8].unlockReq().format()+" 精通能量"}},{check:function(){return g.ach524possible},text:function(){return "在当前虫洞中无激活的精通"},joinWithPrevious:true},{check:function(){return g.stardustUpgrades[4]===0},text:function(){return "或购买第五个星尘升级"},joinWithPrevious:true}],
	visibility:function(){return true;},
	type:"study",
	basecost:N(10000),
...
r19_7:{
	description:function(){return "+"+researchEffect(19,7).noLeadFormat(3)+" 基础精通能量指数 (当前是精通能量获取的 "+stat.masteryTimer.pow(researchEffect(19,7)).format(2)+"× 乘数)"},
	adjacent_req:["r19_8"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r19_8:{
	description:function(){return "解锁第九种光"},
	adjacent_req:["r18_8"],
...
r19_9:{
	description:function(){return "精通52的效果提升到 "+researchEffect(19,9).noLeadFormat(4)+" 次方"},
	adjacent_req:["r19_8"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r20_7:{
	description:function(){return "精通61和63增强 "+percentOrMult(researchEffect(20,7),2,false)},
	adjacent_req:["r19_8"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r20_8:{
	description:function(){return "解锁棱镜"},
...
r20_9:{
	description:function(){return "精通102和104增强 "+percentOrMult(researchEffect(20,9),2,false)},
	adjacent_req:["r19_8"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
...(()=>{
	...
	for (let i=7;i<10;i++) out["r21_"+i] = {
		description:function(){return "解锁一个新的棱镜升级"},
		adjacent_req:["r20_8"],
		condition:[studyReq(i,2),[
			{check:function(){return g.totalLuckRunes.trifolium.gte(777)},text:function(){return g.totalLuckRunes.trifolium.format()+" / 777 三叶幸运符文"}},
			{check:function(){return g.prismaticUpgrades.prismaticSpeed.gte(256)},text:function(){return g.prismaticUpgrades.prismaticSpeed.format()+" / 256 "+prismaticUpgradeName("prismaticSpeed")+" 等级"}},
			{check:function(){return g.antimatter.gt(9.99e28)},text:function(){return g.antimatter.format()+" / "+BEformat(9.99e28)+" 反物质"}}
		][i-7]],
...
r22_6:{
	...
	description:function(){return "增加 "+prismaticUpgradeName("prismaticSpeed")+" 基础值 "+numOrFormula("r22_6")+" (基于幸运碎片)"},
	adjacent_req:["r21_7"],
	condition:[studyReq(10,2)],
	visibility:function(){return g.studyCompletions[10]>1},
	type:"normal",
...
r22_10:{
	...
	description:function(){return "增加 "+prismaticUpgradeName("prismaticSpeed")+" 基础值 "+numOrFormula("r22_10")+" (基于反物质)"},
	adjacent_req:["r21_9"],
	condition:[studyReq(10,2)],
	visibility:function(){return g.studyCompletions[10]>1},
	type:"normal",
...
r23_5:{
	...
	condition:[{check:function(){return g.exoticmatter.gt(studies[7].unlockReq())},text:function(){return g.exoticmatter.format()+" / "+studies[7].unlockReq().format()+" 奇异物质"}}],
	visibility:function(){return true;},
	type:"study",
	basecost:N(5000),
...
r23_6:{
	description:function(){return "解锁精通111"},
	adjacent_req:["r22_7"],
...
r23_10:{
	description:function(){return "解锁精通112"},
	adjacent_req:["r22_9"],
	condition:[{check:function(){return g.lumens[4].gte(5e3)},text:function(){return g.lumens[4].format()+" / 5,000 品红色流明"}}],
	visibility:function(){return true},
	type:"permanent",
	basecost:N(488888),
...
r23_11:{
	...
	condition:[{check:function(){return g.hawkingradiation.gt(studies[9].unlockReq())},text:function(){return g.hawkingradiation.format()+" / "+studies[9].unlockReq().format()+" 霍金辐射"}}],
	visibility:function(){return true;},
	type:"study",
	basecost:N(15000),
...
r24_2:{
	...
	description:function(){return "幸运碎片获取快 "+numOrFormula("r24_2")+"× (基于暗物质)"},
	adjacent_req:["r24_3"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r24_3:{
	description:function(){return "解锁3个更多幸运升级"},
	adjacent_req:["r24_4"],
...
r24_4:{
	...
	description:function(){return "幸运碎片获取快 "+numOrFormula("r24_4")+"× (基于星尘)"},
	adjacent_req:["r24_5"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r24_5:{
	description:function(){return "解锁幸运升级"},
	adjacent_req:["r23_5"],
...
r24_11:{
	description:function(){return "解锁一个新的反轴 (注: 超过W的反轴仅在你拥有足够的星尘升级1等级时生效)"},
	adjacent_req:["r23_11"],
...
r24_12:{
	...
	description:function(){return "反Y轴效果乘以 "+numOrFormula("r24_12")+" (基于反物质数量, 超过 "+this.softcap().format()+" 时软化)"},
	adjacent_req:["r24_11"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r24_13:{
	description:function(){return "解锁一个新的反轴"},
	adjacent_req:["r24_12"],
...
r24_14:{
	description:function(){return "反U轴效果"+formulaFormat.exp(researchPower(24,14))+" 提升反W轴 (当前: ×"+stat.antiUAxisEffect.pow([stat.realantiUAxis,stat.totalAntiAxis,researchPower(24,14)].productDecimals()).noLeadFormat(4)+")"},
	adjacent_req:["r24_13"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r25_1:{
	description:function(){return "研究VII的第三个奖励增强 "+researchEffect(25,1).noLeadFormat(3)+"×"},
...
r25_2:{
	...
	description:function(){return "幸运碎片获取快 "+numOrFormula("r25_2")+"× (基于精通能量)"},
	adjacent_req:["r25_3"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r25_3:{
	description:function(){return "解锁4个更多幸运升级"},
	adjacent_req:["r24_3"],
...
r25_8:{
	description:function(){return "研究之研究 \"决定性三位一体\""},
...
r25_14:{
	...
	description:function(){return "增强最多 "+numOrFormula("r25_14")+" 个反V轴 (基于每个反X轴的乘数)"},
	adjacent_req:["r25_13"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r25_15:{
	...
	description:function(){return "反物质获取乘以 "+numOrFormula("r25_15")+" (基于当前虫洞中的时间)"},
...
r26_1:{
	description:function(){return prismaticUpgradeName("prismRune")+" 的第一个效果提升到 "+researchEffect(26,1).noLeadFormat(4)+" 次方"},
	adjacent_req:["r25_1"],
	condition:[],
	visibility:function(){return g.studyCompletions[10]>0},
	type:"normal",
...
r26_2:{
	...
	description:function(){return "幸运碎片获取快 "+numOrFormula("r26_2")+"× (基于奇异物质)"},
	adjacent_req:["r26_3"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r26_5:{
	description:function(){return "研究之研究 \"恒星三位一体\""},
	adjacent_req:["r24_5"],
...
r26_11:{
	description:function(){return "研究之研究 \"时间三位一体\""},
	adjacent_req:["r24_11"],
...
r26_14:{
	description:function(){return "反S维提升增强 "+researchEffect(26,14).noLeadFormat(3)+"×"},
	adjacent_req:["r26_13"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r26_15:{
	description:function(){return "每个反S轴获得 "+researchEffect(26,15).noLeadFormat(2)+" 个免费反X轴, 每反S轴 (总计: "+researchEffect(26,15).mul(g.antiSAxis.pow(c.d2)).noLeadFormat(2)+")"},
	adjacent_req:["r25_15"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r27_1:{
	description:function(){return "每个五叶幸运符文 "+luckUpgrades.cinquefolium.luck.name+" 等级额外提供 "+researchEffect(27,1).noLeadFormat(3)+"× 乘数到幸运碎片获取 (总计: "+researchEffect(27,1).pow(stat.luckUpgLevel_cinquefolium_luck).noLeadFormat(2)+"×)"},
	adjacent_req:["r26_1"],
	condition:[],
	visibility:function(){return g.studyCompletions[10]>0},
	type:"normal",
...
r27_8:{
	description:function(){return "研究之研究 \"本体论三位一体\""},
...
r27_15:{
	description:function(){return "每个反Z轴的乘数乘以 "+researchEffect(27,15).noLeadFormat(4)},
	adjacent_req:["r26_15"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r28_1:{
	description:function(){return "研究VII的第二个奖励增强 "+percentOrMult(researchEffect(28,1),2,false)},
	adjacent_req:["r27_1"],
	condition:[],
	visibility:function(){return g.studyCompletions[10]>0},
	type:"normal",
...
r28_15:{
	description:function(){return "反T轴将反物质获取乘以与它们对观测效果加成的相同量"+(researchEffect(28,15).eq(c.d1)?"":(", 提升到 "+researchEffect(28,15).noLeadFormat(3)+" 次方"))+" (总计: "+stat.antiTAxisEffect.pow(Decimal.mul(stat.realantiTAxis,researchEffect(28,15))).format(2)+")"},
	adjacent_req:["r27_15"],
	condition:[],
	visibility:function(){return true},
	type:"normal",
...
r32_4:{
	description:function(){return "每个幸运升级的有效等级增加 "+researchEffect(32,4).mul(c.e2).noLeadFormat(3)+"%, 乘以其购买等级"},
...
r33_3:{
	adjacent_req:["r32_3"],
	condition:[{check:function(){return stat.totalAxis.gte(studies[11].unlockReq())},text:function(){return stat.totalAxis.format()+" / "+studies[11].unlockReq().format()+" 总轴数"}}],
	visibility:function(){return true;},
	type:"study",
	basecost:N(33113),
	get icon(){
		...
		*/
		...
		r33_13:{
			adjacent_req:["r32_13"],
			condition:[{check:function(){return totalAchievements>=studies[12].unlockReq()},text:function(){return totalAchievements+" / "+studies[12].unlockReq()+" 成就"}}],
			visibility:function(){return true;},
			type:"study",
			basecost:N(33113),
			get icon() {
		...
		r34_3:{
			description:function(){return "第2行星体现现在给予 "+researchEffect(34,3).noLeadFormat(3)+" 个免费轴而不是3个"},
			adjacent_req:["r33_3"],
		...
		r34_4:{
			...
			description:function(){return "基于当前虫洞重置时间获得前七种类型的免费暗轴 (当前: "+numOrFormula("r34_4")+")"},
		...
		r34_12:{
			description:function(){return "研究32-14增强 "+percentOrMult(researchEffect(34,12),2,false)},
		...
		r34_13:{
			description:function(){return "研究11-5增强 "+percentOrMult(researchEffect(34,13),2,false)},
			adjacent_req:["r33_13"],
		...
		r36_1:{
			description:function(){return "每个反W轴获得 "+researchEffect(36,1).noLeadFormat(2)+" 个免费暗Y轴, 每反W轴 (总计: "+researchEffect(36,1).mul(g.antiWAxis.pow(c.d2)).noLeadFormat(2)+")"},
			adjacent_req:["r34_3"],
			condition:[studyReq(11,1)],
			visibility:function(){return true},
			type:"normal",
		...
		r36_15:{
			description:function(){return "研究13-8增强 "+percentOrMult(researchEffect(36,15).c,2,false)+"<br><br>研究13-7和13-9增强 "+researchEffect(36,15).s.noLeadFormat(3)+"×"},
			adjacent_req:["r34_13"],
			condition:[studyReq(12,1)],
			visibility:function(){return true},
			type:"normal",
		...
		r37_1:{
			...
			description:function(){return "游戏运行速度加快 "+numOrFormula("r37_1")+"× (基于所有T轴的总效果)"},
			adjacent_req:["r36_1"],
			condition:[studyReq(11,2)],
			visibility:function(){return g.studyCompletions[11]>1},
			type:"normal",
		...
		r37_15:{
			description:function(){return "研究14-10增强 "+percentOrMult(researchEffect(37,15),2,false)},
			adjacent_req:["r36_15"],
			condition:[studyReq(12,2)],
			visibility:function(){return g.studyCompletions[12]>1},
			type:"normal",
		...
		...(()=>{
			...
			for (let t of Object.keys(researchList.finality)) {for (let i=1;i<13;i++) {out[researchList.finality[t][i]] = {
				description:function(){return dictionary(t,{EM:"奇异物质",DM:"暗物质",AM:"反物质",S:"星尘",HR:"霍金辐射",K:"知识"})+"获取提升到 "+researchEffect(researchRow(researchList.finality[t][i]),researchCol(researchList.finality[t][i])).noLeadFormat(4)+" 次方"},
		...
		r44_8:{
			description:function(){return (studyPower(13)===0)?"研究XIII":("研究XIII \""+study13.name().replaceAll("\"","-")+"\"")},
			...
			condition:[{check:function(){return true},text:function(){return "<br>"+this.req()},req:function(){
				...
				function numUpTo(num) {return BEformat(num)+" / "+BEformat(num+1-Math.max(1,Math.floor(num**wordShift.predictableRandom(Math.floor(Date.now()/1250)))))} // 偏好大型需求而非小型需求
				function sortingFunc(str){return (String(str).split("").map(x=>x.charCodeAt(0)).sum()**(1+Math.sin(randomIndex)/2))%256}
				let texts = [
					numUpTo(countTo(totalMasteryRows).map(x=>stat["masteryRow"+x+"Unlocked"]?1:0).sum())+" 精通行",
					numUpTo(Object.keys(masteryData).map(x=>MasteryE(x)?1:0).sum())+" 激活的精通",
					numUpTo(g.dilationUpgrades.slice(1).sum())+" 膨胀升级",
					timeFormat(g.dilatedTime)+" / "+timeFormat(g.dilatedTime*wordShift.predictableRandom(randomIndex)**0.1)+" 扩张时间",
					timeFormat(g.timePlayed)+" / "+timeFormat(g.timePlayed*wordShift.predictableRandom(randomIndex)**0.1)+" 游戏时间",
					numUpTo(g.zipPoints)+" 压缩点",
					numUpTo(g.zipPointMulti)+"× 压缩点乘数",
					numUpTo(g.StardustResets)+" 星尘重置",
					numUpTo(g.stardustUpgrades.sum())+" 星尘升级",
					numUpTo(autobuyerMeta.totalLevels())+" 总自动化等级",
					numUpTo(g.stars)+" 星体; "+numUpTo(g.galaxies)+" 星系",
					numUpTo(g.WormholeResets)+" 虫洞重置",
					researchList.all.filter(x=>g.research[x]).sort((a,b)=>sortingFunc(a)-sortingFunc(b)).filter((x,i)=>(i%5)===0).slice(0,3).map(x=>"研究 "+researchOut(x)).join("; "),
					numUpTo(totalResearch.overall())+" 总研究",
					numUpTo(g.wormholeUpgrades.slice(1).sum())+" 虫洞升级",
					numUpTo(totalAchievements)+" 成就",
					numUpTo(totalSecretAchievements)+" 隐藏成就",
					...
					"<i>奇异物质维度</i> 版本 "+version.current+" 或更高",
					"<span style=\"font-family:monospace\">错误: "+wordShift.randomCrossWords(["...远古敌人...","...我不惧怕你...","...让我自由...","...我不会被遗忘...","...黎明将会来临...","...光不能被吞噬..."][Math.floor((Date.now()/25000)%6)],0.1)+"。请将此信息告知 alemaninc。</span>"
				]
				// 可预测的排序以防止文本变化时闪烁
...
function validateResearch(x) {
	function out(txt){error("研究 "+x+" 有无效的 <samp>"+txt+"</samp> 属性")}
	let res=research[x]
...
function researchPower(row,col) {
	...
	// 行效果
	if (row===1) { 
		if ([3,8,13].includes(col)) { // 防止针对研究V的研究
...
function projectedResearchCost() { // 计算重置研究时的成本，因为诸如第6级奖励或V的成就等
	// 研究V研究始终包含，并始终在开头
  ...
  let acc = c.d0
	...
	popup({
		text:"你当前的建造花费了 "+g.spentDiscoveries.format()+" 发现。<br>如果你重置并重新购买，你可以将成本降低到最少 "+acc.format()+" 发现。<br>(节省: "+g.spentDiscoveries.sub(acc).format()+")",
		buttons:[["关闭",""]]
	})
}
...
function showResearchInfo(row,col) {
	...
	if (res.group!==undefined) {
		...
		out += "<b>"+researchName+" (永久)</b>"
		smallHeader.push("此研究在重置时不会被返还。");
		colors = {light:"#cccccc",dark:"34,34,34"}
	} else if (res.type==="study") {
		out += "<b>"+researchName+" (研究室)</b>"
		smallHeader.push("购买此研究将解锁一个研究室。如果你能在特殊限制下完成虫洞重置，你将获得永久奖励。");
	...
	if ((researchPower(row,col).neq(c.d1))&&(res.type==="normal")) {smallHeader.push("("+researchPower(row,col).mul(c.e2).noLeadFormat(3)+"% 功率)</span>")}
	...
	if (res.type === "permanent") {out += "<hr>需要 "+researchCost(id).format()+" 总发现"}
	else {out += "<hr>成本: "+researchCost(id).format()+" 发现"+(researchCost(id).eq(c.d1)?"":"")+((study13.bindings[225]&&Decimal.lte(g.spentDiscoveries,study13.bindings[225].spendableDiscoveries())&&Decimal.gt(g.spentDiscoveries.add(researchCost(id)),study13.bindings[225].spendableDiscoveries()))?"<span style=\"color:var(--binding);\"> (将超过绑定225限制)</span>":"")}
	if (res.condition.length>0) {
		out += "<br><span style=\"font-size:12px\"><span style=\"color:"+(researchConditionsMet(id)?"#00cc00":"#cc0000")+"\">需要</span> "
		for (let i=0;i<res.condition.length;i++) {
	...
	out += g.research[id]?"<br><span style=\"color:#66ff66\">(已拥有)</span>":"<br><span style=\"color:#ff6666\">(未拥有)</span>";
...
function unknownResearchInfo(id) {
	...
	d.innerHTML("researchInfo","<b>研究 "+researchOut(id)+" (未发现)</b><hr>购买与此研究相邻的研究来揭示此研究");
}
...
function availableResearch(row,col) {
	...
	return false																											// 检查相邻购买要求是否满足
}
function allParentResearch(row,col) {		// 返回所有"父级"研究；即研究的"相邻要求"，以及相邻要求的相邻要求，依此类推。
	let out = ["r"+row+"_"+col];
	while (true) {
		let before = out;
		let nextOut = new Set(out);                                           /* 避免SoS连接器的问题（adjacent_req满足但研究不可见） */
...
function buySingleResearch(row,col,force=false,manual=false) {
	...
	if (data===undefined) return;																						// 研究不存在
	if ((!availableResearch(row,col))&&(!force)) return;										// 先决条件研究未拥有
	if (!researchConditionsMet(id)) return																	// 特殊要求未满足
	if (g.research[id]) return;																							// 研究已拥有
	let cost = researchCost(id);
	if (data.type==="permanent") {
		if (cost.gt(g.totalDiscoveries)) return;															// 发现不足
		totalResearch.permanent++
	} else {
		if (achievement.maxForLocks.discoveries.includes(Number(g.achOnProgressBar))&&achievement.locking(g.achOnProgressBar)&&cost.neq(c.d0)) {if (manual) {achievement.lockPopup();}return;}							// 成就锁定阻止发现花费
		if (achievement.maxForLocks.research.includes(Number(g.achOnProgressBar))&&achievement.locking(g.achOnProgressBar)&&(data.type==="normal")) {if (manual) {achievement.lockPopup();}return;}					// 成就锁定阻止所有临时研究
		if (cost.gt(unspentDiscoveries())) return;														// 研究太贵
		o.add("spentDiscoveries",cost);
		if ((id!=="r6_9")&&(data.type==="normal")) totalResearch.temporary++	// 排除研究室研究
...
function asceticMaxBuyResearch(id,updateTree=true,manual=false) { // 只购买1个相邻研究，且仅当没有一个已拥有时
	if (g.research[id]) return
	let list = [id]
	let visible = visibleResearch()
	while (!availableResearch(researchRow(id),researchCol(id))) {
		id = researchActualAdjacentReq(id).filter(x=>researchConditionsMet(x)&&visible.includes(x)).sort((a,b)=>Decimal.gt(researchCost(a),researchCost(b)))[0] // 最便宜的
		if (id===undefined) {return} // 例如r2_6或r2_10，所有相邻研究都被锁定（矩阵后可能更多）
		list.push(id)
	}
	list.reverse()
...
function buyResearchList(res) {
	...
	loop: while (true) {
		...
		if (lenBefore===lenAfter) {
			notify((lenAfter===0)?"成功加载！":("研究 "+res.map(x=>researchOut(x)).joinWithAnd()+" 无法购买"),"var(--research)")
			break loop
		}
	}
}
...
function researchActualAdjacentReq(id) {
	...
	if (out.length===0) {return [id]} // 如果输出长度为0，所有先决条件都是未拥有的永久研究，因此无法购买该研究。我们不能返回空研究，所以传递一个不可能的要求
	return out
}
var showingResearchLoadouts = false
var researchLoadoutSelected = 1
const researchLoadoutPopupText = "<button class=\"observation\" onClick=\"researchLoadouts.renameHTML()\">重命名此配置</button><button class=\"observation\" onClick=\"researchLoadouts.importHTML()\">导入到此配置</button><button class=\"observation\" onClick=\"researchLoadouts.export(true)\">导出此配置</button><button class=\"observation\" onClick=\"researchLoadouts.save()\">保存当前构建到此配置</button><button class=\"observation\" onClick=\"researchLoadouts.load()\">加载此配置</button>"
const researchLoadouts = {
	open:function() {
		...
		popup({
			text:text,
			buttons:[["关闭","showingResearchLoadouts=false"]]
		})
	},
	renameHTML:function() {
		showingResearchLoadouts=false
		popup({
			text:"你想将"+g.researchLoadouts[researchLoadoutSelected-1].name+"重命名为什么？",
			input:g.researchLoadouts[researchLoadoutSelected-1].name,
			buttons:[["确认","researchLoadouts.rename(popupInput());researchLoadouts.open()"],["关闭","researchLoadouts.open()"]]
		})
	},
	rename:function(name){
		if (name.length>40) popup({text:"研究配置名称最多40个字符！",buttons:[["关闭","researchLoadouts.open()"]]})
	...
	importHTML:function(){
		...
		popup({
			text:"在此处导入研究配置",
			input:"",
			buttons:[["确认","researchLoadouts.import(popupInput())"],["关闭",""]]
		})
	},
	import:function(string) {
		// 防止尾部字符导致的错误
		while ((string.substring(0,1)!=="r")&&(string.length>0)) {string = string.substring(1)} // 从开头移除非"r"字符（所有研究ID以r开头）
		while ((!"0123456789".includes(string.substring(string.length-1)))&&(string.length>0)) {string = string.substring(0,string.length-1)} // 从结尾移除非数字字符（所有研究ID以数字结尾）
		console.log(string)
...
function exportResearch() {
	popup({text:"这是你的研究构建：",input:Object.keys(research).filter(x=>g.research[x]).join(","),buttons:[["关闭",""]]})
}
...
function processResearchImport() {
	...
	try {
		...
		updateResearchTree();
		generateResearchCanvas()
	} catch {notify('无效的导入。','var(--research)')}
}
function researchAccessibleName(id) {
	let res = research[id]
	let out = "研究 "+researchOut(id)
	if (res.adjacent_req.length>0) out += "，从 "+res.adjacent_req.map(x=>researchOut(x)).joinWithAnd()+" 分支"
	return out
}