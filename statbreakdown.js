...
const statList = [
	{
		...
		entries:[
			{
				text:function(){return "玩家名称:<br>{0}<br><br><button onMousedown=\"changePlayerName()\" class=\"genericbutton size4\">更改</button>"},
			...
			{
				text:function(){return "获得{0}个成就<br><br>（+ {1}个秘密成就）"},
				visible:function(){return true},
				variables:{
			...
			{
				text:function(){return "总计{0}个轴"+(unlocked("Dark Matter")?("<br><br>（"+[["{1}个普通轴",true],["{2}个暗轴",true],["{3}个反轴",unlocked("Antimatter")]].filter(x=>x[1]).map(x=>x[0]).join(",<br>")+"）"):"")},
				visible:function(){return true},
				variables:{
			...
			{
				text:function(){return "总计{0}个自动化等级"},
			...
			{
				text:function(){return "帧间隔{0}毫秒<br><br>（细粒度帧间隔{1}毫秒）"},
				visible:function(){return true},
				variables:{
			...
			{
				text:function(){return "EMD等级{0}<br>（分数：{1}）<br><button class=\"information\" onMousedown=\"EMDScore(true)\" style=\"color:inherit;border-color:inherit;\">i</button>"},
				visible:function(){return true},
				variables:{
	...
	},
	{
		...
		entries:[
			{
				text:function(){return "游戏时间{0}<br><br>（考虑滴速：{1}）"},
				visible:function(){return true},
				variables:{
			...
			{
				text:function(){return "总计产生{0}奇异物质"},
				visible:function(){return true},
				variables:{
			...
			{
				text:function(){return "总计产生{0}星尘"},
			...
			{
				text:function(){return "总计产生{0}暗物质"},
			...
			{
				text:function(){return "总计产生{0}霍金辐射"},
			...
			{
				text:function(){return "总计产生{0}反物质"},
	...
	},
	{
		...
		entries:[
			{
				text:function(){return "耗时{0}<br><br>（考虑滴速：{1}）"},
				visible:function(){return unlocked("Stardust")},
				variables:{
			...
			{
				text:function(){return "产生{0}奇异物质"},
				visible:function(){return unlocked("Stardust")},
				variables:{
			...
			{
				text:function(){return "重置{0}次<br><br>（{1}次有奖励）"},
				visible:function(){return unlocked("Stardust")},
				variables:{
	...
	},
	{
		...
		entries:[
			{
				text:function(){return "<b>普通轴折算</b><br><br><table style=\"table-layout:fixed;\"><tr><td style=\"text-align:left;width:60px;\">开始</td><td style=\"text-align:right;width:150px;\">{0}</td></tr><tr><td style=\"text-align:left;width:60px;\">指数</td><td style=\"text-align:right;width:150px;\">{1}%</td></tr></table>"},
			...
			{
				text:function(){return "<b>普通轴超级折算</b><br><br><table style=\"table-layout:fixed;\"><tr><td style=\"text-align:left;width:60px;\">开始</td><td style=\"text-align:right;width:150px;\">{0}</td></tr><tr><td style=\"text-align:left;width:60px;\">指数</td><td style=\"text-align:right;width:150px;\">{1}%</td></tr></table>"},
			...
			{
				text:function(){return "<b>暗轴折算</b><br><br><table style=\"table-layout:fixed;\"><tr><td style=\"text-align:left;width:60px;\">开始</td><td style=\"text-align:right;width:150px;\">{0}</td></tr><tr><td style=\"text-align:left;width:60px;\">指数</td><td style=\"text-align:right;width:150px;\">{1}%</td></tr></table>"},
			...
			{
				text:function(){return "<b>暗轴超级折算</b><br><br><table style=\"table-layout:fixed;\"><tr><td style=\"text-align:left;width:60px;\">开始</td><td style=\"text-align:right;width:150px;\">{0}</td></tr><tr><td style=\"text-align:left;width:60px;\">指数</td><td style=\"text-align:right;width:150px;\">{1}%</td></tr></table>"},
			...
			{
				text:function(){return "<b>反轴折算</b><br><br><table style=\"table-layout:fixed;\"><tr><td style=\"text-align:left;width:60px;\">开始</td><td style=\"text-align:right;width:150px;\">{0}</td></tr><tr><td style=\"text-align:left;width:60px;\">指数</td><td style=\"text-align:right;width:150px;\">{1}%</td></tr></table>"},
			...
			{
				text:function(){return "<b>反轴超级折算</b><br><br><table style=\"table-layout:fixed;\"><tr><td style=\"text-align:left;width:60px;\">开始</td><td style=\"text-align:right;width:150px;\">{0}</td></tr><tr><td style=\"text-align:left;width:60px;\">指数</td><td style=\"text-align:right;width:150px;\">{1}%</td></tr></table>"},
			...
			{
				text:function(){return "<b>免费轴软上限边界</b><br><br><table style=\"table-layout:fixed;\"><tr><td style=\"text-align:left;width:60px;\">开始</td><td style=\"text-align:right;width:150px;\">{0}%</td></tr><tr><td style=\"text-align:left;width:60px;\">限制</td><td style=\"text-align:right;width:150px;\">{1}%</td></tr></table>"},
			...
			{
				text:function(){return "<b>星折算</b><br><br><table style=\"table-layout:fixed;\"><tr><td style=\"text-align:left;width:60px;\">开始</td><td style=\"text-align:right;width:150px;\">{0}</td></tr><tr><td style=\"text-align:left;width:60px;\">指数</td><td style=\"text-align:right;width:150px;\">{1}%</td></tr></table>"},
			...
			{
				text:function(){return "<b>暗星折算</b><br><br><table style=\"table-layout:fixed;\"><tr><td style=\"text-align:left;width:60px;\">开始</td><td style=\"text-align:right;width:150px;\">{0}</td></tr><tr><td style=\"text-align:left;width:60px;\">指数</td><td style=\"text-align:right;width:150px;\">{1}%</td></tr></table>"},
	...
	},
	{
		...
		entries:[
			...
			{
				text:function(){return "{0}×压缩点获取倍率"},
...
const largeNumberVisualizationVariables = [
	{label:"奇异物质",class:"_exoticmatter",value:function(){return g.exoticmatter}},
	{label:"精通能量",class:"_mastery",value:function(){return g.masteryPower}},
	{label:"星尘",class:"_stardust",value:function(){return g.stardust}},
	{label:"暗物质",class:"_darkmatter",value:function(){return g.darkmatter}},
	{label:"暗能量",class:"_energy",value:function(){return g.darkEnergy}},
	{label:"霍金辐射",class:"_wormhole",value:function(){return g.hawkingradiation}},
	{label:"知识",class:"_research",value:function(){return g.knowledge}},
	{label:"反物质",class:"_antimatter",value:function(){return g.antimatter}}
]
const largeNumberVisualizationNumbers = [
	{name:achievement.label(311)+"需求",value:c.ee3,visible:function(){return g.achievement[311]}},
	{name:achievement.label(413)+"需求",value:c.e44031,visible:function(){return g.achievement[413]}},
	{name:achievement.label(529)+"需求",value:c.ee6,visible:function(){return g.achievement[529]}},
	{name:achievement.label(805)+"需求",value:Decimal.FC_NN(1,2,60),visible:function(){return g.achievement[805]}},
	{name:"2⇈5",value:c.d2.pow(65536)},
	{name:"3⇈3",value:c.d3.pow(c.d27)},
	{name:"4⇈3",value:N(2**512)},
	{name:"attillion",value:N(3e18).pow10()},
	{value:N(6.02214076e23),name:"阿伏伽德罗常数"},
	{value:[c.e,c.pi,c.e,c.pi].decimalPowerTower().mul(794843294078147843293.7+1/30),name:"Ballium数"},
	{value:c.e10,name:"对话"},
	{value:c.inf,name:"双精度浮点无穷大"},
	{value:N(17 * 2**259),name:"爱丁顿数"},
	{value:N(3e15+3).pow10(),name:"femtillion"},
	{value:c.e100,name:"古戈尔"},
	{value:N("ee100"),name:"古戈尔普勒克斯"},
	{value:c.d2.pow(276709),name:"《银河系漫游指南》数"},
	{value:c.d2.pow(82589933),name:"截至2023年2月已知最大质数"},
	{value:N(3000003).pow10(),name:"micrillion"},
	{value:N(3003).pow10(),name:"millillion"},
	{value:N(3e9+3).pow10(),name:"nanillion"},
	{value:N(7.401196841564901e45),name:"4<sup>3</sup>魔方组合数"},
	{value:N(2**27 * 3**14 * 125 * 49 * 11),name:"魔方组合数"},
	{value:N(3e12+3),name:"picillion"},
	{value:c.d2.pow(16384),name:"四倍精度浮点无穷大"},
	{value:N(3e30).pow10(),name:"quectillion"},
	{value:N(3e27).pow10(),name:"rontillion"},
	{value:N(1.989e33),name:"太阳质量/克"},
	{value:c.ee10,name:"三边对话"},
	{value:N(8.4506e184),name:"可观测宇宙体积/普朗克长度<span class=\"xscript\"><sup>3</sup><sub>P</sub></span>"},
...
function visualiseLargeNumber(x) {
	...
	if (x.gt(c.d10.quad_tetr(c.inflog))) {return "层F(（"+comparison.name+"），<i>n</i> → <i>n</i> × "+Decimal.div(x.quad_slog(c.d10),comparison.value.quad_slog(c.d10)).format(4)}
...
const statTemplates = {
	...
	axisSoftcap:function(type,color){
		return {
			...
			show:function(){return Decimal.div(stat["free"+type+"Axis"],g[type+"Axis"]).gt(stat.freeAxisSoftcapStart)}, // 循环引用在show()中是合法的
			color:color
		};
	},
	funcOnly:function(callback){return { // 用于永不显示的修饰符
		label:"",
		func:callback,
	...
	tickspeed:function(exp,label="滴速",dependencies=[]){
		if (exp===undefined) return {
			...
			color:(label==="滴速"?"var(--time)":"inherit")
		}
	},
	ach209Reward:{
	...
	duofoliumSpace:{
		label:"双叶"+luckUpgrades.duofolium.space.name,
	...
	modifiers:[
		{
			...
			text:function(){return g.exoticmatter.gt(stat.stardustExoticMatterReq.div(c.d10))?("10 ^ log("+statFormat("EM",g.exoticmatter.format(),"_exoticmatter")+" ÷ "+stat.stardustExoticMatterReq.div(c.d10).format()+") ^ "+studies[4].reward(1).noLeadFormat(3)):("需要至少 "+stat.stardustExoticMatterReq.format()+" 奇异物质");},
	...
	modifiers:[
		{
			...
			text:function(){return statFormat("精通计时器",stat.masteryTimer.format(2),"_time")+" ^ "+statFormat("基础获取量指数",stat.baseMasteryPowerExponent.format(4),"_mastery");},
...
miscStats.baseMasteryPowerExponent={
	...
	modifiers:[
		...
		{
			label:"<span onMousedown=\"addSecretAchievement(9)\">隐藏成就</span>",
			mod:function(){return secretAchievementPoints/1e16},
			func:function(prev){return prev}, // 奖励是骗人的！alemaninc 真残忍。
...
miscStats.masteryTimer={
	...
	modifiers:[
		...
		{
			get label(){return visibleStudies().includes(8)?"研究 VIII 奖励 3":achievement.label(310)},
...
for (let i=0;i<axisCodes.length;i++) {
	...
	if (i<7) out.push({
		label:"五叶"+luckUpgrades.cinquefolium.axis.name,
...
for (let group of ["","dark","anti"]) {
	let groupName = ((group==="")?"":(group==="dark")?"暗":"反")
	for (let i=0;i<axisCodes.length;i++) {
		let type = axisCodes[i]
		let out = [
			{
				label:"已购买"+groupName+type+"轴",
...
miscStats.axisCostExponent={
	...
	modifiers:[
		...
		{
			label:"三叶"+luckUpgrades.trifolium.normalAxis.name,
...
miscStats.darkAxisCostExponent={
	...
	modifiers:[
		...
		{
			label:"三叶"+luckUpgrades.trifolium.darkAxis.name,
...
miscStats.antiAxisCostExponent={
	...
	modifiers:[
		...
		{
			label:"三叶"+luckUpgrades.trifolium.antiAxis.name,
...
miscStats.energyGainSpeed={
	...
	modifiers:[
		...
		statTemplates.tickspeed(()=>[
			...
			studies[10].reward(3)
		].sumDecimals(),"滴速",["redLightEffect",...bindingDependencies(245)])
	]
};
	...
	modifiers:[
		{
			...
			text:function(){return stat.totalDarkAxis.gte(stat.wormholeDarkAxisReq)?("2 ^ "+unbreak("("+statFormat("ΣA",stat.totalDarkAxis.format(0),"_darkmatter")+" ÷ 1,500)")+" ^ "+stat.HRBaseApexExp.noLeadFormat(4)):("需要至少 "+stat.wormholeDarkAxisReq.format()+" 个总暗轴");},
...
miscStats.HRMultiplier={
	...
	modifiers:[
		...
		{
			label:"五叶草 "+luckUpgrades.cinquefolium.radiation.name,
...
for (let i=0;i<axisCodes.length;i++) {
	...
	if (i<7) out.push(
		{
			label:"五叶草 "+luckUpgrades.cinquefolium.axis.name,
...
miscStats.knowledgePerSec={
	...
	modifiers:[
		...
		statTemplates.tickspeed(()=>studies[6].reward(2),"研究VI奖励2",[...bindingDependencies(265)]),
		{
...
miscStats.chromaPerSec={
	...
	modifiers:[
		...
		{
			label:"五叶草 "+luckUpgrades.cinquefolium.chroma.name,
...
miscStats.luckShardsPerSec={
	...
	modifiers:[
		...
		// 指数
		{
			label:"五叶草 "+luckUpgrades.cinquefolium.luck.name,
	...
	miscStats["luckUpgLevel_"+type+"_"+upg] = {
		...
		modifiers:(()=>{
			...
			if (type!=="unifolium") out.push({
				label:"一叶草 "+luckUpgrades.unifolium.cascade.name,
...
miscStats.antimatterPerSec={
	...
	modifiers:[
		...
		// 滴速
		statTemplates.tickspeed(()=>g.achievement[916]?achievement(916).effect():c.d1,"滴速",["realAntimatterGalaxies"])
	]
}
...
function updateStats() {
	if (debugActive) {
		...
		if (out.length>0) error("以下统计数据映射不正确:"+out.map(x=>"<br>"+x[0]+" (之前: "+x[1]+", 之后: "+x[2]+")").join(""))
	} else {
		for (let i of statOrder) updateStat(i)
	}
}
...
function statBreakdownCategories() {
	...
	d.innerHTML("SSBnav1",categories.sort().map(x => "<button id=\"button_SSBnav1_"+x+"\" class=\"tabtier3 statistics\" style=\"filter:brightness("+(x==="奇异物质获得"?100:75)+"%)\" onClick=\"toggleActiveBreakdownSection('"+x+"');updateHTML()\">"+x+"</button>").join(" "))
	d.innerHTML("SSBtable","<tr><th class=\"tablecell\" style=\"width:25vw\">来源</th><th class=\"tablecell\" style=\"width:45vw\">修正项</th><th class=\"tablecell\" style=\"width:25vw\">小计</th></tr>"+Array(maximumSSBModifierLength).fill(0).map((x,i)=>"<tr id=\"SSBtable_row"+i+"\"><td class=\"tablecell\" style=\"width:25vw\" id=\"SSBtable_label"+i+"\"></td><td class=\"tablecell\" style=\"width:45vw\" id=\"SSBtable_text"+i+"\"></td><td class=\"tablecell\" style=\"width:25vw\" id=\"SSBtable_total"+i+"\"></td></tr>").join(""))
}
var activeBreakdownSection = "奇异物质获得";
...
function toggleActiveBreakdownTab(x){
	...
	if (breakdownCategories[activeBreakdownSection]) {
		breakdownCategories[activeBreakdownSection].active=x;
	}
	activeBreakdownTabModifierLength = miscStats[x]?.modifiers?.length || 0
	let categories = breakdownCategories[activeBreakdownSection]?.contents || []
	if (categories.length>1) for (let i of categories) {
		let element = d.element("button_SSBnav2_"+i)
		if (element) element.style.filter = "brightness("+(i===x?100:75)+"%)"
	}
}
